...
echo "  Examples:"
echo ""
echo "  Run the penq-bin binary"
echo ""
echo "    ${cmdname} penq-bin"
echo ""
echo "  Debug the penq-bin binary in gdb"
echo ""
echo "    ${cmdname} -g penq-bin -d gdb"
echo ""
echo "  Run penq-bin under valgrind with arguments"
echo ""
echo "    ${cmdname} -g -d valgrind -a '--tool=memcheck --leak-check=full' penq-bin"
echo ""
	return 0
}
##########################################################################
