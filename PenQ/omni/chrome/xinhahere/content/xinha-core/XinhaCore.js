  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --  $LastChangedDate: 2008-04-15 11:11:12 -0700 (Tue, 15 Apr 2008) $
...
Xinha.version =
{
  ...
  'Date'      : '$LastChangedDate: 2008-04-15 11:11:12 -0700 (Tue, 15 Apr 2008) $'.replace(/^[^:]*: ([0-9-]*) ([0-9:]*) ([+0-9]*) \((.*)\) \$/, '$4 $2 $3'),
  'Revision'  : '$LastChangedRevision: 994 $'.replace(/^[^:]*: (.*) \$$/, '$1'),
 ...
 * @version $Rev: 994 $ $LastChangedDate: 2008-04-15 11:11:12 -0700 (Tue, 15 Apr 2008) $
 * @constructor
...
Xinha.Config = function()
{
 ...
 /** You can tell the fullscreen mode to leave certain margins on each side.<br />
  ...
  this.btnList =
  {
    ...
    selectall: [ "Select all", "ed_selectall.png", false, function(e) {e.execCommand("selectall");} ],
    ...
    lefttoright: [ "Direction left to right", ["ed_buttons_main.png",0,4], false, function(e) { e.execCommand("lefttoright"); } ],
    righttoleft: [ "Direction right to left", ["ed_buttons_main.png",1,4], false, function(e) { e.execCommand("righttoleft"); } ],
